...
new Vue({
  ...
  methods: {
    ...
    removeCurWindow: function removeCurWindow(callback) {
      var curWindowID;
      return regeneratorRuntime.async(function removeCurWindow$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(this.getCurrentWindowID());
  ...
  beforeCreate: function beforeCreate() {
    ...
    chrome.runtime.onMessage.addListener(function (request, sender, sendResponse) {
      ...
      var _JSON$parse = JSON.parse(JSON.stringify(request)),
          txInfoArr = _JSON$parse.txInfoArr;
  ...
  mounted: function mounted() {
    ...
    this.txInfo = store.state.txInfo;
  }
});
